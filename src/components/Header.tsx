    ...
    <header className="relative h-12 bg-white/90 dark:bg-gray-800/90 backdrop-blur-lg border-b border-gray-200/50 dark:border-gray-700/50 shadow-lg shadow-gray-900/5 dark:shadow-black/20 z-50">
      ...
      <div className="relative flex items-center justify-between h-full px-3 sm:px-4 lg:px-6">
        <div className="flex items-center space-x-2 sm:space-x-3">
          ...
          <button 
            className={`group relative p-2 rounded-xl transition-all duration-300 transform hover:scale-110 focus:scale-110 focus-ring ${
              sidebarOpen 
        ...
        <div className="flex items-center space-x-2">
          ...
          <div className="relative">
            <select 
              ...
              className="appearance-none bg-white/80 dark:bg-gray-700/80 backdrop-blur-sm border border-gray-300/50 dark:border-gray-600/50 rounded-xl px-3 py-1.5 pr-8 text-xs lg:text-sm text-gray-900 dark:text-gray-100 focus-ring transition-all duration-300 hover:border-postman-orange/50 hover:shadow-lg hover:shadow-postman-orange/10 cursor-pointer"
            >
          ...
          <button 
            ...
            className="group relative p-2 rounded-xl bg-white/80 dark:bg-gray-700/80 backdrop-blur-sm border border-gray-300/50 dark:border-gray-600/50 text-gray-700 dark:text-gray-300 hover:text-postman-orange dark:hover:text-postman-orange focus-ring transition-all duration-300 hover:border-postman-orange/50 hover:shadow-lg hover:shadow-postman-orange/10 hover:scale-110 transform"
