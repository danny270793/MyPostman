            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="flex-1">
                <input
                  ...
                  className="w-full px-3 py-2 text-sm bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-md text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400 focus:ring-2 focus:ring-postman-orange focus:border-transparent"
                />
              </div>
